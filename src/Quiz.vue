<template>
  <div class="d-flex justify-content-center">
    ...
    <span v-if="!startQuiz">
        ...
        class="mb-2"
        >
        <b-img src="https://www.artst.org/wp-content/uploads/2020/06/Famous-Paintings.jpg" alt="Image" fluid></b-img>
        <b-card-text>
            Based on the work of Arpan Adhikari: <a target="_blank" href="https://github.com/arpan45/simple-quiz-vue"> Github Repo </a>
        </b-card-text>
    ...
    img-top
  >
   <b-img :src="require( `./assets/${questions[currentQuestion].questionImage}`)" alt="Image" fluid thumbnail></b-img>
   <b-card-text>  
